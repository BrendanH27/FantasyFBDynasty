...
export const URLS = {
  ...
  // Draft picks
  API_GET_DRAFT_PICKS: `${BASE_API_URL}/draft-picks`,
  API_GET_DRAFT_PICKS_BY_LEAGUE: (leagueId: number) => `${BASE_API_URL}/draft-picks/league/${leagueId}`,
  ...
  // Team Players
  API_GET_TEAM_PLAYERS: `${BASE_API_URL}/team-players`,
  API_GET_TEAM_PLAYERS_BY_TEAM: (teamId: number) => `${BASE_API_URL}/team-players/team/${teamId}`,
};
